...
export default function Hero() {
  return (
    <div className="bg-radial-left relative h-screen min-h-[760px]">
      <div className="flex h-full w-full flex-col gap-12 overflow-hidden px-10 pt-[50px] sm:pt-[80px] md:flex-row md:pb-20 xl:px-16">
        {/* Info */}
        <div className="relative z-20 flex w-full flex-1 flex-col items-center justify-center gap-9 text-center text-primary-dark sm:gap-24 md:items-start md:gap-16 md:text-left lg:gap-24 lg:pr-10">
          ...
          <div className="flex flex-col gap-5 sm:gap-10">
            <h1 className="max-w-2xl font-serif text-6xl font-extrabold sm:text-7xl md:text-6xl xl:text-7xl 2xl:text-8xl">
              Reabilitando vidas autistas.
            </h1>
            <h2 className="hidden text-lg font-normal sm:block sm:text-xl md:max-w-2xl md:text-lg lg:text-xl">
              Construindo uma comunidade solidária, nossos profissionais
              voluntários oferecem suporte holístico, abrangendo desde a
              compreensão até serviços especializados para autistas e suas
              famílias.
            </h2>
            <h2 className="text-lg font-normal sm:hidden sm:text-xl md:max-w-2xl md:text-lg lg:text-xl">
              Construindo uma comunidade solidária, oferecemos suporte holístico
              e serviços especializados para autistas e suas famílias.
            </h2>
          ...
          <div className="flex w-full max-w-[300px] flex-row flex-wrap justify-between gap-4 sm:max-w-[460px] md:flex-col lg:max-w-[440px] xl:flex-row xl:gap-5 2xl:max-w-[510px]">
            <div className="flex flex-col items-center gap-1 md:flex-row md:items-end md:gap-2 xl:flex-col xl:items-start xl:gap-1">
              <span className="text-2xl font-extrabold md:text-2xl xl:text-3xl">
                +7
              </span>
